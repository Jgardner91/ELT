-- postgres ingest procedure
create or replace procedure transform.postgres_ingest()
    returns variant 
    language javascript 
    EXECUTE AS CALLER 
    as 
    $$
        ...
        var copy_into = snowflake.createStatement({sqlText: "copy into raw.first_leads_delta from @transform.postgres_stg_area"});
        copy_into.execute();
        ...
        var merge_statement = `MERGE INTO raw.first_leads as a USING raw.first_leads_delta as b ON a.id = b.id
                            ...
                            a.datawarehouseinserttime = current_timestamp(2)
